_base_ = [
    ...
    '../_base_/datasets/sketchyscene_rgb.py',
...
model = dict(
    ...
    decode_head=dict(type='MDFHeadWithLocalDetail', image_size=750, in_channels=[64, 128, 320, 512], in_index=[0, 1, 2, 3], num_classes=46, with_local_detail=True, mdf_block_num=2,
                     loss_decode=dict(type='CustomCrossEntropyLoss', label_smoothing=0.1))
)

work_dir='work_dirs/sketchseger_sketchyscene'
